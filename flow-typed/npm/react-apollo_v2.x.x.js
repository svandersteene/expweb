...
declare module "react-apollo" {
    ...
    declare class ObservableQuery<T> extends Observable<ApolloQueryResult<T>> {
        ...
        fetchMore(
            fetchMoreOptions: FetchMoreQueryOptions<any> &
    ...
    declare class DataStore<TSerialized> {
        ...
        markMutationInit(mutation: {
            ...
            update:
                | ((proxy: DataProxy, mutationResult: Object) => mixed)
                | void,
    ...
    declare class Observable<T> {
        ...
        flatMap<R>(
            fn: (value: T) => ZenObservableObservableLike<R>,
        ): Observable<R>;

        from<R>(
            observable:
                | Observable<R>
                | ZenObservableObservableLike<R>
                | Array<R>,
        ): Observable<R>;
    ...
    > {
        ...
        stopPolling: () => void;
        subscribeToMore: (
            options: SubscribeToMoreOptions<any, any>,
        ) => () => void;
        updateQuery: (
            mapFn: (
                previousQueryResult: any,
