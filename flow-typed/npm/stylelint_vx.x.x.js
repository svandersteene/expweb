// flow-typed signature: 354a3aeea7f4c8782caae22e6687b835
// flow-typed version: <<STUB>>/stylelint_v^9.9.0/flow_v0.89.0
...
declare module "stylelint/lib/rules/block-no-empty/index.js" {
    declare module.exports: $Exports<
        "stylelint/lib/rules/block-no-empty/index",
    >;
}
...
declare module "stylelint/lib/rules/color-hex-case/index.js" {
    declare module.exports: $Exports<
        "stylelint/lib/rules/color-hex-case/index",
    >;
}
...
declare module "stylelint/lib/rules/max-empty-lines/index.js" {
    declare module.exports: $Exports<
        "stylelint/lib/rules/max-empty-lines/index",
    >;
}
declare module "stylelint/lib/rules/max-line-length/index.js" {
    declare module.exports: $Exports<
        "stylelint/lib/rules/max-line-length/index",
    >;
}
...
declare module "stylelint/lib/rules/no-empty-first-line/index.js" {
    declare module.exports: $Exports<
        "stylelint/lib/rules/no-empty-first-line/index",
    >;
}
declare module "stylelint/lib/rules/no-empty-source/index.js" {
    declare module.exports: $Exports<
        "stylelint/lib/rules/no-empty-source/index",
    >;
}
...
declare module "stylelint/lib/rules/selector-max-id/index.js" {
    declare module.exports: $Exports<
        "stylelint/lib/rules/selector-max-id/index",
    >;
}
...
declare module "stylelint/lib/rules/unit-blacklist/index.js" {
    declare module.exports: $Exports<
        "stylelint/lib/rules/unit-blacklist/index",
    >;
}
...
declare module "stylelint/lib/rules/unit-no-unknown/index.js" {
    declare module.exports: $Exports<
        "stylelint/lib/rules/unit-no-unknown/index",
    >;
}
declare module "stylelint/lib/rules/unit-whitelist/index.js" {
    declare module.exports: $Exports<
        "stylelint/lib/rules/unit-whitelist/index",
    >;
}
...
declare module "stylelint/lib/testUtils/createRuleTester.js" {
    declare module.exports: $Exports<
        "stylelint/lib/testUtils/createRuleTester",
    >;
}
